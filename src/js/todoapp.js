class Todo {
    ...
    updateCount() {
      ...
      this.nodes.count.innerHTML =
        this.count > 1 ? `${this.count} tapşırıq` : `${this.count} tapşırıq`;
    }
    ...
    emptyListUI(message = "Tapşırıq yoxdur") {
    ...
    generalUI() {
      ...
      this.nodes.count = this.elementCreator({
        markup: this.count > 1 ? `${this.count} tapşırıq` : `${this.count} task`,
        attributes: {
          class: "task-count"
        },
  ...
  const todoList = [
    {
      id: -1,
      name: "Garage Academy-e getmek",
      completed: true
    },
    {
      id: -2,
      name: "Tapsiriqlari GitHub yuklemek",
      completed: true
    },
    {
      id: -3,
      name: "JS haqqinda oxumaq arashdirmaq",
      completed: false
    },
    {
      id: -4,
      name: "HTML CSS Haqqinda oxumaq",
      completed: false
    },
  ];
